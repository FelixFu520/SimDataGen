...
from sdg_utils.occupancy import OccSlice2DMeta, render_occ_map_with_rig
...
class OccupancyMapPanel:
    ...
    def __init__(self, meta: OccSlice2DMeta, init_pose: List[float]):
        ...
        with self._window.frame:
            with ui.VStack(spacing=4):
                ui.Label(
                    f"z={meta['slice_z']:.2f} m  |  res={meta['resolution']:.2f} m/px",
                    height=20,
                )
