...
TASKS=(
  ...
  # TaoBao08 场景（TaoBao08_00 生成数据少些；TaoBao08_01 生成数据多些）
  # (1)第一批生成数据, 使用4cam-lut相机, DataGen_omni代码，每个场景生成4800帧数据
  ...
  # (1)第一批生成数据, 使用4cam-lut-2H30YA相机, DataGen代码，每个场景生成4800帧数据
  ...
  # (1)第一批生成数据, 使用4cam-lut-2H30YA相机, DataGen代码，每个场景生成2400帧数据
  ...
  # TaoBao09 场景
  # (1)第一批生成数据, 使用4cam-lut-2H30YA相机, DataGen代码，每个场景生成9600帧数据
  ...
  # (1)第一批生成数据, 使用4cam-lut-2H30YA相机, OCCUPANCY_RESOLUTION=0.1, ERODE=2, DILATE=2, ENVELOPE=40
  # kujiale_0003                                              # OKK
  # kujiale_0004                                              # OKK
  # kujiale_0008                                              # OKK
  # kujiale_0009                                              # OKK
