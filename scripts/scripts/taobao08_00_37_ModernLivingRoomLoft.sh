...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/37_ModernLivingRoomLoft/37_ModernLivingRoomLoft.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_37_ModernLivingRoomLoft_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
