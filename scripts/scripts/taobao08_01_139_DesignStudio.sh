...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/139_DesignStudio/139_DesignStudio.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_139_DesignStudio_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
