...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao04/027_FuelBar/Fuel_Bar.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao04/taobao04_027_FuelBar_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
