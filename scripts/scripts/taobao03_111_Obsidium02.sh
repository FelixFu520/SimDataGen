...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/111_Obsidium02/L_OBS_Underground_Chapel.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_111_Obsidium02_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
