...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao05/160_Archinteriors/AIUE_vol10_02.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao05/taobao05_160_Archinteriors_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
