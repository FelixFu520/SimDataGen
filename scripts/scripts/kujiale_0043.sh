...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/kujiale/kujiale_0043/kujiale_0043.usda"
OUTPUT_DIR="${PROJECT_DIR}/workdir/kujiale/kujiale_0043_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
