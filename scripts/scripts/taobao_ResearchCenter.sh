...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/ResearchCenter/Showcase.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_ResearchCenter_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
