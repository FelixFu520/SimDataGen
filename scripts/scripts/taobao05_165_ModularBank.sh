...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao05/165_ModularBank/BankBuild.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao05/taobao05_165_ModularBank_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
