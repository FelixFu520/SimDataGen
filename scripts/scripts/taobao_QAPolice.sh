...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/QAPoliceStation/OA_PoliceStation_Demo_nophy.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_QAPolice_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
