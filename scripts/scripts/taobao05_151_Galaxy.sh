...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao05/151_Galaxy/Galaxy_Example_Blueprints.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao05/taobao05_151_Galaxy_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
