...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/65_BlueAndWhiteKitchenWithDiningArea/65_BlueAndWhiteKitchenWithDiningArea.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_65_BlueAndWhiteKitchenWithDiningArea_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
