...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/PostSovietFlat2/Demo_01.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_PostSovietFlat2_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
