...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/036_WillsRoom/Showcase.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_036_WillsRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
