...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/222_ASubwayTrain/Demonstration.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_222_ASubwayTrain_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
