...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/173_ModernBedroomInSunset/173_ModernBedroomInSunset.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_173_ModernBedroomInSunset_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
