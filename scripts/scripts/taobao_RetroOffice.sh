...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/RetroOffice/Demonstation2.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_RetroOffice_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
