...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao04/029_ShoppingMall/Demonstration.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao04/taobao04_029_ShoppingMall_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
OCCUPANCY_RESOLUTION=0.5
NUM_POINTS=$NUM_POINTS_ENV
NUM_PATHS=$NUM_PATHS_ENV
MAX_ANGLE_DEVIATION=4.0
ERODE_ITERATIONS=4
OBSTACLE_DILATE_ITERATIONS=4
