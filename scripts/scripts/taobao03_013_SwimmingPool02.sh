...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/013_SwimmingPool02/Demonstration_AlternatePool.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_013_SwimmingPool02_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
