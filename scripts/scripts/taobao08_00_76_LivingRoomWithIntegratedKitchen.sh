...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/76_LivingRoomWithIntegratedKitchen/76_LivingRoomWithIntegratedKitchen.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_76_LivingRoomWithIntegratedKitchen_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
