...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/67_ModernLivingRoom/67_ModernLivingRoom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_67_ModernLivingRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
