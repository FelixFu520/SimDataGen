...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/8_ModernApartmentLivingRoom(Part1)/8_ModernApartmentLivingRoom(Part1).usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_8_ModernApartmentLivingRoom(Part1)_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
