...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/187_KidsBedroomScene/187_KidsBedroomScene.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_187_KidsBedroomScene_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
