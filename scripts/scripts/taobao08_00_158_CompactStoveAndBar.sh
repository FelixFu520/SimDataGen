...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/158_CompactStoveAndBar/158_CompactStoveAndBar.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_158_CompactStoveAndBar_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
