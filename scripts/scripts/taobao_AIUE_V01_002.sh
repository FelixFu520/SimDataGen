...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/AIUE_V01_002/AIUE_V01_002.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_AIUE_V01_002_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
