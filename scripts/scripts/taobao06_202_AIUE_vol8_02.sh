...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/202_AIUE_vol8_02/AIUE_vol8_02.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_202_AIUE_vol8_02_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
