...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao09/11_changlang/NewWorld.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao09/taobao09_11_changlang_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
