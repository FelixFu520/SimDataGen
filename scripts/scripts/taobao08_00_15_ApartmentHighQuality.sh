...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/15_ApartmentHighQuality/15_ApartmentHighQuality.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_15_ApartmentHighQuality_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
