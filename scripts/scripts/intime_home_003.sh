...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/Intime_Home/home_003/home_003.usdc"
OUTPUT_DIR="${PROJECT_DIR}/workdir/Intime_Home/intime_home_003_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
