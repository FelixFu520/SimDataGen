...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/kujiale/kujiale_0040/kujiale_0040.usda"
OUTPUT_DIR="${PROJECT_DIR}/workdir/kujiale/kujiale_0040_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
