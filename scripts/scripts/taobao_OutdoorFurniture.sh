...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/OutdoorFurniture/Afternoon.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_OutdoorFurniture_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
