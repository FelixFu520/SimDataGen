...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao09/28_ChinaModular/Demonstration.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao09/taobao09_28_ChinaModular_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
