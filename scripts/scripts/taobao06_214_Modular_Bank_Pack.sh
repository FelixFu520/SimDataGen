...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/214_Modular_Bank_Pack/BankBuild.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_214_Modular_Bank_Pack_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
