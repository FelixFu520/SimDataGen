...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao10/007/GT_Grid_Armada_Military_Base.usdc"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao10/taobao10_007_GT_Grid_Armada_Military_Base_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
