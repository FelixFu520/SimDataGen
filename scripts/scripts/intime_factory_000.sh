...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/Intime_Home/factory000/factory.usdc"
OUTPUT_DIR="${PROJECT_DIR}/workdir/Intime_Home/intime_factory_000_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
