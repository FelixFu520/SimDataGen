...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/221_ShowroomKit/Example_Map_A.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_221_ShowroomKit_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
