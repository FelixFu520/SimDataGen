...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/26_BedroomMorden/26_BedroomMorden.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_26_BedroomMorden_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
