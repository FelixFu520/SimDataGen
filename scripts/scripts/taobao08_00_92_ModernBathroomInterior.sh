...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/92_ModernBathroomInterior/92_ModernBathroomInterior.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_92_ModernBathroomInterior_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
