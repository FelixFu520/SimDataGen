...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/118_ModernMinimalistKitchenInterior/118_ModernMinimalistKitchenInterior.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_118_ModernMinimalistKitchenInterior_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
