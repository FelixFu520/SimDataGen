...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/kujiale/kujiale_0009/kujiale_0009.usda"
OUTPUT_DIR="${PROJECT_DIR}/workdir/kujiale/kujiale_0009_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
