...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/216_Triplex_House_Villa/BigTriplexHouseVilla.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_216_Triplex_House_Villa_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
