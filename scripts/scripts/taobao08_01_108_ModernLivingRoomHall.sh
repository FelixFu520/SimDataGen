...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/108_ModernLivingRoomHall/108_ModernLivingRoomHall.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_108_ModernLivingRoomHall_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
