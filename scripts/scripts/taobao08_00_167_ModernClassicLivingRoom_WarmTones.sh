...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/167_ModernClassicLivingRoom–WarmTones/167_ModernClassicLivingRoom–WarmTones.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_167_ModernClassicLivingRoom–WarmTones_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
