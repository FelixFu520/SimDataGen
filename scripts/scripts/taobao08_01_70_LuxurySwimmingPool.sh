...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/70_LuxurySwimmingPool/70_LuxurySwimmingPool.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_70_LuxurySwimmingPool_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
