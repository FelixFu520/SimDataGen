...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/208_Archinteriors/AIUE5_vol12_01.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_208_Archinteriors_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
