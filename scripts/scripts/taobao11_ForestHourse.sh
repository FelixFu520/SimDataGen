...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao11_fix2/ForestHourse/Map_Houses_A.thinned.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao11_fix2/taobao11_ForestHourse_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
