...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/kujiale/kujiale_0031/kujiale_0031.usda"
OUTPUT_DIR="${PROJECT_DIR}/workdir/kujiale/kujiale_0031_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
