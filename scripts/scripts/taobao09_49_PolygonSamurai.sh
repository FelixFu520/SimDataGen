...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao09/49_PolygonSamurai/Demonstration.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao09/taobao09_49_PolygonSamurai_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
...
OBSTACLE_ENVELOPE_ITERATIONS=5
