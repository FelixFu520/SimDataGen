...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/50_ModernPurpleLivingRoom/50_ModernPurpleLivingRoom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_50_ModernPurpleLivingRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
