...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao09/24_ShintoShrine/ShintoShrine_Showcase.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao09/taobao09_24_ShintoShrine_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
