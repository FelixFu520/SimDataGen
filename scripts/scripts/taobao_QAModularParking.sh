...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/QAModularParking/Map_demonstration.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_QAModularParking_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
