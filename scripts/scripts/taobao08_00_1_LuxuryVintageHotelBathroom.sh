...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/1_LuxuryVintageHotelBathroom/1_LuxuryVintageHotelBathroom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_1_LuxuryVintageHotelBathroom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
