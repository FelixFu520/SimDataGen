...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/018_Fluorescence/World_map.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_018_Fluorescence_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
