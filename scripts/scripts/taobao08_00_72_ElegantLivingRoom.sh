...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/72_ElegantLivingRoom/72_ElegantLivingRoom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_72_ElegantLivingRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
