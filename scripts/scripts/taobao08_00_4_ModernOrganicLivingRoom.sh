...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/4_ModernOrganicLivingRoom/4_ModernOrganicLivingRoom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_4_ModernOrganicLivingRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
