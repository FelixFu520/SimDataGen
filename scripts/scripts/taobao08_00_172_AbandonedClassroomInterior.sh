...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/172_AbandonedClassroomInterior/172_AbandonedClassroomInterior.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_172_AbandonedClassroomInterior_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
