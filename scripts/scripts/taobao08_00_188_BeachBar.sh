...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/188_BeachBar/188_BeachBar.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_188_BeachBar_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
