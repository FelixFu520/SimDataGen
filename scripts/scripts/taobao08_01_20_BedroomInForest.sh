...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/20_BedroomInForest/20_BedroomInForest.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_20_BedroomInForest_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
