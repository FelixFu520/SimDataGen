...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/105_LivingRoomInterior(Concept)/105_LivingRoomInterior(Concept).usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_105_LivingRoomInterior(Concept)_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
