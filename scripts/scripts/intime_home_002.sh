...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/Intime_Home/home_002/home_002.usdc"
OUTPUT_DIR="${PROJECT_DIR}/workdir/Intime_Home/intime_home_002_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
