...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/226_LoftOffice_workspace/WorkSpace.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_226_LoftOffice_workspace_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
