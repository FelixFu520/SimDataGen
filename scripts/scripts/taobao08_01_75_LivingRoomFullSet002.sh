...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/75_LivingRoomFullSet002/75_LivingRoomFullSet002.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_75_LivingRoomFullSet002_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
