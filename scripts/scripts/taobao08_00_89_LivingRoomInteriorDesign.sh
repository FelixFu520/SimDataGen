...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/89_LivingRoomInteriorDesign/89_LivingRoomInteriorDesign.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_89_LivingRoomInteriorDesign_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
