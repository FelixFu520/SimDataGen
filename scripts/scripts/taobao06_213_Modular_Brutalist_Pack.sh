...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/213_Modular_Brutalist_Pack/EnvironmentExemplar_01.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_213_Modular_Brutalist_Pack_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
