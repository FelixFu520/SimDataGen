...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/001_ModernHomeHouseInteriorw/SampleMap.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_001_ModernHomeHouseInteriorw_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
...
OBSTACLE_ENVELOPE_ITERATIONS=100
