...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/kujiale/kujiale_0022/kujiale_0022.usda"
OUTPUT_DIR="${PROJECT_DIR}/workdir/kujiale/kujiale_0022_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
