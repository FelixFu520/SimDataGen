...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/106_Showroom/Example_Map_A.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_106_Showroom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
