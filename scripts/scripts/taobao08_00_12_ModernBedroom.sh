...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/12_ModernBedroom/12_ModernBedroom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_12_ModernBedroom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
