...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/25_BedroomHighQuality/25_BedroomHighQuality.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_25_BedroomHighQuality_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
