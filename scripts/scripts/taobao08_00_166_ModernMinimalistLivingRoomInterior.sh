...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/166_ModernMinimalistLivingRoomInterior/166_ModernMinimalistLivingRoomInterior.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_166_ModernMinimalistLivingRoomInterior_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
