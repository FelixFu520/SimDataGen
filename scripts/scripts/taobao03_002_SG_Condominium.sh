...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/002_SG_Condominium/SG_Condominium.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_002_SG_Condominium_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
