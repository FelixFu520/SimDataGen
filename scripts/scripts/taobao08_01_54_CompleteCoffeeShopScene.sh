...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/54_CompleteCoffeeShopScene/54_CompleteCoffeeShopScene.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_54_CompleteCoffeeShopScene_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
