...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/AI_vol33_scene_04/AI_vol3_scene_04.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_AI_vol33_scene_04_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
