...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/129_LivingRoomAndKitchenFullset/129_LivingRoomAndKitchenFullset.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_129_LivingRoomAndKitchenFullset_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
