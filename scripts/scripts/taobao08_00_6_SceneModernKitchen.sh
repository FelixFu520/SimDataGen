...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/6_SceneModernKitchen/6_SceneModernKitchen.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_6_SceneModernKitchen_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
