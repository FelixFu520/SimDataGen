...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/OfficeMeetingRoom2/Overview.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_OfficeMeetingRoom2_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
