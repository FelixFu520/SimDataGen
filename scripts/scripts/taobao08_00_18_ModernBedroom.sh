...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/18_ModernBedroom/18_ModernBedroom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_18_ModernBedroom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
