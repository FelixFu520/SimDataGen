...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao09/05_ModularJapaneseTemple/Showcase.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao09/taobao09_05_ModularJapaneseTemple_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
