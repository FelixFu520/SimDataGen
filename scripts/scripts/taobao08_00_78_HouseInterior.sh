...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/78_HouseInterior(Complete)/78_HouseInterior(Complete).usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_78_HouseInterior(Complete)_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
