...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao04/107_Airport/Terminal_Single03.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao04/taobao04_107_Airport_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
