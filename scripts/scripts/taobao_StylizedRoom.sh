...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao/StylizedRoom/LVL_IL_SR_Vol1_Demo.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao/taobao_StylizedRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
