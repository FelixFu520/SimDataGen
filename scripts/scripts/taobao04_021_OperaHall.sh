...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao04/021_OperaHall/Preview.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao04/taobao04_021_OperaHall_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
...
OBSTACLE_ENVELOPE_ITERATIONS=6
