...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/13_ModernBedroom/13_ModernBedroom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_13_ModernBedroom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
