...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/178_LowPolyRoom/178_LowPolyRoom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_178_LowPolyRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
