...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/219_SoftwareServer/Modular_Server.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_219_SoftwareServer_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
