...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_01/49_ModernDecoLivingRoom/49_ModernDecoLivingRoom.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_01/taobao08_01_49_ModernDecoLivingRoom_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
