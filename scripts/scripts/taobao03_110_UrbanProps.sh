...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/110_UrbanProps/Overview_01_01_P.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_110_UrbanProps_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
