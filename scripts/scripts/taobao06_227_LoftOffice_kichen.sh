...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/227_LoftOffice_kichen/Kitchen.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_227_LoftOffice_kichen_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
