...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/205_AIUE_vol8_05/AIUE_vol8_05.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_205_AIUE_vol8_05_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
