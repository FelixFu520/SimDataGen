...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/201_AIUE_vol8_01/AIUE_vol8_01.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_201_AIUE_vol8_01_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
