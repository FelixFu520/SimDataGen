...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao06/207_Sci-Fi_Living_Room/SciFiLivingRoom1_DemoA.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao06/taobao06_207_Sci_Fi_Living_Room_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
