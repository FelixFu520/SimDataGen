...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao08_00/91_LivingRoomFullset01/91_LivingRoomFullset01.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao08_00/taobao08_00_91_LivingRoomFullset01_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
