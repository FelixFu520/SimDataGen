...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao02/AI_vol3_scene_04/AI_vol3_scene_04_2.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao02/taobao02_AI_vol3_scene_04_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
...
OBSTACLE_ENVELOPE_ITERATIONS=30
