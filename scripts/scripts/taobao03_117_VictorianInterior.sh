...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao03/117_VictorianInterior/OldLibrary.usd"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao03/taobao03_117_VictorianInterior_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
