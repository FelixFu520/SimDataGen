...
SCENE_USD_URL="${PROJECT_DIR}/assets_extern/TaoBao10/001/AE37_001_Blender.usdc"
OUTPUT_DIR="${PROJECT_DIR}/workdir/TaoBao10/taobao10_001_AE37_001_Blender_${SEED_ENV}_${NUM_PATHS_ENV}_${NUM_POINTS_ENV}"
